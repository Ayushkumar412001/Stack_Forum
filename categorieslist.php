...
<body>
    ...
    <?php
        ...
        $sql1 = "SELECT * FROM `ask` WHERE ask_cat_id = $id";
        $result1 = mysqli_query($conn,$sql1);
        $total_q = mysqli_num_rows($result1);
    ...
    <div class="concatlist">
        <div class="listhead">
            ...
            <?php echo '<a href="ask.php?catid='.$id.'">Ask Question</a>'; ?>
        </div>
    ...
    <div class="question">
        <h2> (<?php echo $total_q; ?>) Questions related to <?php echo $catname; ?> <i class="fas fa-chevron-right"></i></h2>
    </div>

    <?php
        // $id = $_GET['catid'] ;
        $sql = "SELECT * FROM `ask` WHERE ask_cat_id = $id ORDER BY `timestamp` DESC";
        $result = mysqli_query($conn,$sql);
        ...
        if ($noResult) {
            ...
            <div class="concatlist">
                <div class="listhead">
                    ...
                    <a href="ask.php?catid='.$id.'">Ask Question</a>
                </div>
